...
// Show preview function with complete Dean-SA format
    ...
    const eventSummaryHTML = `
            ...
            <div class="report-content">
                ...
                <table style="width: 100%; border-collapse: collapse; font-size: 12px; margin-bottom: 40px; margin-left: auto; margin-right: auto;">
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid #000; padding: 10px; font-weight: bold; background-color: #f8f9fa;">Organised by</td>
        ...
        <div class="report-page">
            ...
            <div style="margin: 0 20px;">
                ...
                <div style="font-size: 13px; line-height: 1.6;">
                    ...
                    <!-- Signature Section for Circular -->
                    <div style="display: flex; justify-content: space-between; align-items: flex-end;">
                    <div style="text-align: center; min-width: 180px;">
        ...
        <div class="report-page">
            ...
            <div style="margin: 0 20px;">
                ...
                <div style="text-align: justify; font-size: 13px; line-height: 1.7; margin: 20px 0;">
                    <p style="margin-bottom: 15px; text-indent: 30px;">${currentFormData.aboutEvent}</p>
                    ${currentFormData.inAssociationWith ? `<p style="margin-top: 20px; font-size: 12px;"><strong>In Association With:</strong> ${currentFormData.inAssociationWith}</p>` : ''}
                </div>
                ${uploadedBrochureBase64 ? `
                <div style="margin: 40px 0;">
                    <h4 style="color: #002d72; font-size: 16px; font-weight: bold; margin-bottom: 15px; text-align: center;">Event Brochure</h4>
                    <div style="text-align: center; border: 2px solid #ddd; padding: 15px; background-color: #f9f9f9;">
                        <img src="${uploadedBrochureBase64}" style="max-width: 90%; height: auto; max-height: 500px;">
                    </div>
                </div>` : ''}
            </div>
        </div>
        ...
        <div class="report-page">
            ...
            <div style="margin: 0 20px;">
                ...
                <div style="margin: 20px 0;">
                    <p style="font-size: 13px; line-height: 1.7; text-align: justify; text-indent: 30px;">
                        The event "${currentFormData.eventName}" was successfully conducted on ${currentFormData.eventDate} at ${currentFormData.venue}. 
                        The event was coordinated by ${currentFormData.eventCoordinator} and organized by ${currentFormData.organisedBy}.
                    </p>
                    
                    <p style="font-size: 13px; line-height: 1.7; text-align: justify; text-indent: 30px; margin-top: 15px;">
                        The resource person for this event was ${currentFormData.resourcePerson}. A total of ${currentFormData.students} students 
                        ${currentFormData.faculty ? `and ${currentFormData.faculty} faculty members` : ''} participated in this event.
                    </p>
                    
                    <p style="font-size: 13px; line-height: 1.7; text-align: justify; text-indent: 30px; margin-top: 15px;">
                        ${currentFormData.aboutEvent}
                    </p>
                    
                    ${currentFormData.inAssociationWith ? `
                    <p style="font-size: 13px; line-height: 1.7; text-align: justify; text-indent: 30px; margin-top: 15px;">
                        This event was conducted in association with ${currentFormData.inAssociationWith}.
                    </p>` : ''}
                </div>
                ...
                <div style="margin: 30px 0;">
                    <p style="font-size: 13px; line-height: 1.7; text-align: justify; text-indent: 30px;">
                        The event was successfully completed and received positive feedback from all participants. 
                        It provided valuable learning opportunities and enhanced the knowledge and skills of the attendees.
                    </p>
                </div>
